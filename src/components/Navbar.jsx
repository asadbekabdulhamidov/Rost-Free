  ...
  return (
    <header>
      <nav className="align-elements flex items-center justify-between py-5">
        ...
        <div className="flex items-center lg:flex-grow lg:pl-8">
            ...
            <span>
              ...
              >
                <rect
                  ...
                  rx="13.5"
                  strokeWidth="#121212"
                  className="fill-transparent stroke-[#121212] transition group-hover:fill-hoverIcon group-hover:stroke-white"
                />
                <rect
                  width="28"
                  height="28"
